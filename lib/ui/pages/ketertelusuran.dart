...
class KetertelusuranPage extends StatefulWidget {
  const KetertelusuranPage({super.key});

  @override
  State<KetertelusuranPage> createState() => _KetertelusuranPageState();
}

class _KetertelusuranPageState extends State<KetertelusuranPage> {
  @override
